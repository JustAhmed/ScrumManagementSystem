...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'backlog_extras': 'backlog.templatetags.backlog_extras',
            }
        },
    },
]
...
EMAIL_USE_TLS = True
EMAIL_HOST = 'smtp.gmail.com'  # to send using outlook email
EMAIL_HOST_USER = ''  # Sender's Email: Must be a gmail account to use google's smtp server
